...
const SidebarItem = ({ item, pageName, setPageName }: any) => {
  ...
  const isActive = pathname === item.route; // Check if the route matches
  ...
  return (
    <li>
      <Link
        ...
        className={`${
          isActive
            ? "bg-gray-800 text-primary dark:bg-white/10 dark:text-white"
            : "text-gray-600 hover:bg-gray-200 hover:text-gray-600 dark:text-gray-5 dark:hover:bg-white/10 dark:hover:text-white"
